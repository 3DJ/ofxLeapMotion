...
%ignore Leap::LeapScreen::LeapScreen(ScreenImplementation*);
...
%constattrib( Leap::LeapScreen, int32_t, id );
%leapattrib( Leap::LeapScreen, Vector, horizontalAxis );
%leapattrib( Leap::LeapScreen, Vector, verticalAxis );
%leapattrib( Leap::LeapScreen, Vector, bottomLeftCorner );
%constattrib( Leap::LeapScreen, int, widthPixels );
%constattrib( Leap::LeapScreen, int, heightPixels );
%constattrib( Leap::LeapScreen, bool, isValid );
...
%staticattrib( Leap::LeapScreen, static const LeapScreen&, invalid );
